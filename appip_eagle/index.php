...
if (isset($_GET['update_time'])) {
    $str = 'appip_bbupup 2019-09-04 13-33-20';
...
<script>
    function download() {
        window.location = "itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/he00495475/gacim/master/manifest.plist";
//        window.location = "itms-services://?action=download-manifest&url=https://demo.acubedt.com/sys_eagle/app/ipa/appip_qpay/manifest.plist";
